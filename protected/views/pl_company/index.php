<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Company Perangkat Lunak</li>
      </ol>
        <br />
        <?php if(Yii::app()->user->role_id=='1' || Yii::app()->user->role_id=='4'): ?> 
        <?php echo CHtml::link('<i class="fa fa-plus"></i>Tambah Company', array('pl_company/create'), array('class'=>'btn btn-default pull-left'));?>
                ...
                <table id="tabel1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach($dataProvider as $data) {
                            ...
                            echo '<td>'.$data->nama_company.'</td>';
                            echo '<td class="text-center">'.
                                    CHtml::link('<i class="fa fa-edit"></i>',array('pl_company/update','id'=>$data->id)).
                                    CHtml::link('<i class="fa fa-remove"></i>',array('pl_company/delete','id'=>$data->id)).
                                    '</td>';
                            echo '</tr>';
                        }
                        ?>
