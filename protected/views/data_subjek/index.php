<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <?php echo CHtml::link('<i class="fa fa-plus"></i>Tambah Subjek Data Inventori', array('data_subjek/create'), array('class'=>'btn btn-default pull-left'));?>
                ...
                <table id="tabel1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach($dataProvider as $data) {
                            ...
                            echo '<td>'.$data->nama_subjek.'</td>';
                            echo '<td class="text-center">'.
                                    CHtml::link('<i class="fa fa-edit"></i>',array('data_subjek/update','id'=>$data->id)).
                                    CHtml::link('<i class="fa fa-remove"></i>',array('data_subjek/delete','id'=>$data->id)).
                                    '</td>';
                            echo '</tr>';
                        }
                        ?>
