...
/**
 * This is the model class for table "simdapel_konsultasi".
 *
 * The followings are the available columns in table 'simdapel_konsultasi':
 * @property integer $id
 * @property integer $judul_id
...
class Konsultasi extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('judul_id',$this->judul_id);
